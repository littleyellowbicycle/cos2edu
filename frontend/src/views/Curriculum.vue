<template>
  <div class="curriculum-page">
    ...
    <div v-else-if="viewMode === 'editor'" class="editor-container">
      <SyllabusEditor
        :modules="modules"
        @saved="onEditorSaved"
        @cancel="onEditorCanceled"
      />
    </div>
  </div>
</template>
...
import GenerateSyllabusDialog from '@/components/curriculum/GenerateSyllabusDialog.vue'
import SyllabusEditor from '@/components/curriculum/SyllabusEditor.vue'
...
async function switchSyllabus(materialId) {
  ...
  ws.activateSyllabus(materialId)
}
